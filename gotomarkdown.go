...
// replaceHypeTag identifies a tag like HYPE[description](path/to/animation.html)
// and replaces it by the correspoding HTML snipped generated by [Tumult Hype](tumult.com).
